...
const MenuItemLink = ({ item, className }: SubMenus) => {
  return (
    <Link to={item.url!} target={item.target} className={classNames("nav-link-ref", "nav-link", className)} data-menu-key={item.key}>
...
interface MainMenuProps {
  ...
  toggleMenu: (item: MenuItemType, show: boolean) => void;
