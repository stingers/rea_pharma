...
// constants
import * as layoutConstants from "../../layouts/constants/layout";
// actions
import {
  changeLayout,
  changeLayoutWidth,
...
const ThemeCustomizer = () => {
  ...
  const { layoutType, layoutWidth, menuPosition, leftSideBarType, leftSideBarTheme, showSidebarUserInfo, topbarTheme } = appSelector(
    (state) => ({
  ...
  const _loadStateFromProps = useCallback(() => {
    ...
    setDisableMenuPositions(
      layoutType !== layoutConstants.LayoutTypes.LAYOUT_TWO_COLUMN && layoutType !== layoutConstants.LayoutTypes.LAYOUT_DETACHED
    );
    ...
    setDisableSidebarUser(
      layoutType !== layoutConstants.LayoutTypes.LAYOUT_HORIZONTAL && layoutType !== layoutConstants.LayoutTypes.LAYOUT_TWO_COLUMN
    );
  }, [layoutType, width]);
  ...
  return (
    <React.Fragment>
      ...
      <div className="p-3">
        ...
        {/* Layouts */}
        <LayoutTypes changeLayoutType={changeLayoutType} layoutType={layoutType} layoutConstants={layoutConstants.LayoutTypes} />

        {/* Width */}
        {disableLayoutWidth && (
          <LayoutWidth changeWidthMode={changeWidthMode} layoutWidth={layoutWidth} layoutConstants={layoutConstants.LayoutWidth} />
        )}

        {/* Topbar */}
        <TopbarTheme changeTopBarTheme={changeTopBarTheme} topbarTheme={topbarTheme} layoutConstants={layoutConstants.TopbarTheme} />
        ...
        {/* User Info */}
        {disableSidebarUser && (
          <SidebarUserInfo toggleLeftSidebarUserInfo={toggleLeftSidebarUserInfo} showSidebarUserInfo={showSidebarUserInfo} />
        )}
