...
import { ProductTransfertForm, ProductTransfertSchema, TransfertForm } from "./ProductTransfertForm";
...
const AdditProductTransfertTwo = ({ tob, onCancelForm, onSubmit }) => {
  ...
  const {
    ...
    setValue,
    watch,
  } = useForm<ProductTransfertForm>({
    defaultValues: { lines: [{}] },
    resolver: yupResolver<any>(ProductTransfertSchema),
    mode: "onChange",
  });
...
export default AdditProductTransfertTwo;
