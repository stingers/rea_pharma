export class ConvertTo {
  numberToLetter(nombre: any) {
    ...
    switch (n) {
      case 1:
        numberToLetter = this.getUnite(nb);
        break;
      case 2:
        if (nb > 19) {
          ...
          if (nb < 71 || (nb > 79 && nb < 91)) {
            if (reste === 0) {
              numberToLetter = this.getDizaine(quotient * 10);
            }
            if (reste === 1) {
              numberToLetter = this.getDizaine(quotient * 10) + "-et-" + this.getUnite(reste);
            }
            if (reste > 1) {
              numberToLetter = this.getDizaine(quotient * 10) + "-" + this.getUnite(reste);
            }
          } else {
            numberToLetter = this.getDizaine((quotient - 1) * 10) + "-" + this.getDizaine(10 + reste);
          }
        } else {
          numberToLetter = this.getDizaine(nb);
        }
        break;
      case 3:
        ...
        if (quotient > 1 && reste === 0) {
          numberToLetter = this.getUnite(quotient) + " cents";
        }
        if (quotient > 1 && reste !== 0) {
          numberToLetter = this.getUnite(quotient) + " cent " + this.numberToLetter(reste);
        }
        break;
      case 4:
  ...
  private getUnite(nombre: number) {
    let unite;
    switch (nombre) {
      case 0:
        unite = "zéro";
  ...
  private getDizaine(nombre: number) {
    let dizaine;
    switch (nombre) {
      case 10:
        dizaine = "dix";
