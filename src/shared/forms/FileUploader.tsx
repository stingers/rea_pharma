                ...
                (selectedFiles || []).map((f, i) => {
                  return (
                    <React.Fragment key={i}>
                      {f.preview && (
                        <div
                          ...
                          <div className="dz-image">
                            <img key={i} data-dz-thumbnail="" alt={f.name} src={f.preview} />
                          </div>
                      ...
                      {!f.preview && (
                        <div onClick={(e) => e.stopPropagation()} className="dz-preview dz-file-preview dz-processing dz-error dz-complete">
                          <div className="dz-image">
