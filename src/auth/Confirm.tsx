...
const Success = () => {
  return (
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 98 98" style={{ height: "120px" }}>
      <g>
      ...
      <AuthLayout>
        <div className="mt-3 text-center">
          ...
          <p className="text-muted mt-2">
            ...
            <span className="fw-medium">youremail@domain.com</span>. Please check for an email from company and click on the included link
