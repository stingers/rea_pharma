import { ProductMvt, Sale } from "asv-hlps";
import dayjs from "dayjs";

export class ProductDefinition {
  // static generic(tob: any , pdfTables: any) {
  static mvtIn(tob: ProductMvt, pdfTables: any) {
    return {
      ...
      content: [
        ...
        {
          text: "Mvt d' entrée N°" + tob.ref + " du " + dayjs(tob.createdAt).format("DD/MM/YYYY : HH:mm"),
          alignment: "justify",
          fontSize: 18,
        },
        "\n",
          ...
          columns: [
            {
              text: [
                {
                  text: [
                    { text: "REF MVT: ", fontSize: 9, color: "#ccc" },
                    { text: tob.ref, bold: true },
                  ],
                },
                "\n",
                {
                  text: [
                    { text: "CREE LE : ", color: "#ccc", fontSize: 9 },
                    { text: dayjs(tob.createdAt).format("DD/MM/YYYY : HH:mm"), bold: true },
                  ],
                },
              ],
            },
